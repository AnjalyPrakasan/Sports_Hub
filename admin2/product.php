...
<form  action="additem_process.php" method="POST"  class="container">
...
<br>
	<table align="center">
                   ...
                   <tr><td>&nbsp;</td></tr> 
						...
						<tr>
				 <td><b><i><font color="black" >ITEM NAME :</b>&nbsp;&nbsp;</td>
				<td><input type='text' size="30" maxlength="30" name='itname' onkeyup="this.value=this.value.toUpperCase()" required></td>
				<td>&nbsp;</td>
				...
				<tr>
					...
					<td><input type='text' name='itprice' size="30" required></td>
				...
				<tr><td>&nbsp;</td></tr>
					...
					<td><input type='text' name='itquantity' size="30" required></td>
				...
				<tr><td>&nbsp;</td></tr>
                    ...
                    <tr>
					<td><b><i><font color="black"> IMAGE:</font></b>&nbsp;&nbsp;</td>
				...
				<tr>
					<th> AVAILABLE </th>
					<td> <input type="radio" name="status" value="no"> NO </td>
				</tr>
